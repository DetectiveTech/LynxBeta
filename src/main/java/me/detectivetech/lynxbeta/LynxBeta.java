package me.detectivetech.lynxbeta;
 ...
 */
public final class LynxBeta extends SimplePlugin {
	...
	*/
	...
	protected void onPluginStart() {
		...
		System.out.println( /*asdasd*/ "hello " + 1 + 1 + "knock knock");
	...
	public void onRightClick(final PlayerInteractEntityEvent event) {
		...
		if (event.getRightClicked().getType() == EntityType.COW)
			event.getRightClicked().getWorld().createExplosion(event.getRightClicked().getLocation(), apple);
	}
	 ...
	 * @return
	 */
	public static LynxBeta getInstance() {
		return (LynxBeta) SimplePlugin.getInstance();
	}
}
